...
// This has been edited from the original version to emit compiler warnings and allow more control
        ...
        if (err) {
          ...
          if (obj.warnings) {
            printErrors(code, opts.js_externs, obj.warnings);
					...
					console.log("Time taken: " + obj.statistics.compileTime + " seconds");
					console.log("Original size: " + (obj.statistics.originalSize / 1024).toFixed(1) + " KB");
					console.log("Compiled size: " + (obj.statistics.compressedSize / 1024).toFixed(1) + " KB");
					console.log("GZipped size: " + (obj.statistics.compressedGzipSize / 1024).toFixed(1) + " KB");

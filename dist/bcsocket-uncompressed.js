...
u.remove = function(a) {
  return eb(this.N, a) ? (delete this.N[a], this.f--, this.$b++, this.j.length > 2 * this.f && db(this), k) : q
};
function db(a) {
  if(a.f != a.j.length) {
...
;function I(a, b) {
  var c;
  if(a instanceof I) {
    this.B = b !== h ? b : a.B, fb(this, a.oa), c = a.Ya, J(this), this.Ya = c, gb(this, a.ga), hb(this, a.za), ib(this, a.G), jb(this, a.Q.n()), c = a.Ka, J(this), this.Ka = c
  }else {
...
O.prototype.Ga = function() {
  if(!this.xb && (this.xb = k, this.t(), 0 != Ab)) {
    var a = z(this);
    delete Bb[a]
  }
};
...
u.Ma = function(a, b, c, d, f, g) {
  ha(a) ? this.Gb = k : a && a.handleEvent && ha(a.handleEvent) ? this.Gb = q : e(Error("Invalid listener argument"));
  this.xa = a;
  this.Sb = b;
  this.src = c;
  this.type = d;
...
u.handleEvent = function(a) {
  return this.Gb ? this.xa.call(this.jb || this.src, a) : this.xa.handleEvent.call(this.xa, a)
};
...
function Lb(a, b, c, d, f) {
  ...
  a: {
    ...
    S[g] || (S[g] = []);
    S[g].push(j);
    a.addEventListener ? (a == v || !a.vb) && a.addEventListener(b, m, d) : a.attachEvent(b in Kb ? Kb[b] : Kb[b] = "on" + b, m);
    a = c
  }
  return a
}
...
function Ob(a) {
  ...
  var c = b.src, d = b.type, f = b.Sb, g = b.capture;
  c.removeEventListener ? (c == v || !c.vb) && c.removeEventListener(d, f, g) : c.detachEvent && c.detachEvent(d in Kb ? Kb[d] : Kb[d] = "on" + d, f);
  c = z(c);
  if(S[c]) {
    var f = S[c], j = Xa(f, b);
...
function Pb(a, b, c, d) {
  if(!d.Oa && d.Kb) {
    for(var f = 0, g = 0;f < d.length;f++) {
      d[f].ma ? d[f].Sb.src = l : (f != g && (d[g] = d[f]), g++)
    }
    d.length = g;
    d.Kb = q;
...
u.Dc = function() {
  if(this.enabled) {
    var a = B() - this.mb;
    0 < a && a < 0.8 * this.ba ? this.r = this.Ca.setTimeout(this.bb, this.ba - a) : (this.dispatchEvent(Vb), this.enabled && (this.r = this.Ca.setTimeout(this.bb, this.ba), this.mb = B()))
  }
};
u.start = function() {
  this.enabled = k;
  this.r || (this.r = this.Ca.setTimeout(this.bb, this.ba), this.mb = B())
};
u.stop = function() {
  this.enabled = q;
...
u.sc = function() {
  this.r = l;
  this.Va && !this.Rb && (this.Va = q, $b(this))
};
function $b(a) {
  var b;
  b = a.fc;
...
function hc(a, b) {
  ...
  rb(a.v, "t", a.Aa);
  a.Da = 0;
  a.l = a.b.fb(a.b.Wa() ? b : l);
  0 < a.la && (a.Ra = new Zb(A(a.bc, a, a.l), a.la));
  Yb(a.hb, a.l, "readystatechange", a.zc);
  var c;
  if(a.u) {
    c = a.u;
    var d = {}, f;
  ...
  a.V ? (a.ra = "POST", c["Content-Type"] = "application/x-www-form-urlencoded", a.l.send(a.v, a.ra, a.V, c)) : (a.ra = "GET", a.Vb && !E && (c.Connection = "close"), a.l.send(a.v, a.ra, l, c));
  a.b.F(kc);
  if(d = a.V) {
    c = "";
    d = d.split("&");
...
u.zc = function(a) {
  a = a.target;
  var b = this.Ra;
  b && 3 == U(a) ? (this.a.debug("Throttling readystatechange."), !b.r && !b.Rb ? $b(b) : b.Va = k) : this.bc(a)
};
u.bc = function(a) {
  try {
    if(a == this.l) {
...
function Ec(a, b) {
  ...
  a.J.parentWindow.d = A(a.Qb, a, k);
  a.J.parentWindow.rpcClose = A(a.Qb, a, q);
...
u.send = function(a, b, c, d) {
  ...
  this.g.onreadystatechange = A(this.Mb, this);
  try {
    X(this.q, Y(this, "Opening Xhr")), this.kb = k, this.g.open(b, a, k), this.kb = q
  }catch(f) {
  ...
  try {
    this.ca && (Ub.clearTimeout(this.ca), this.ca = l), 0 < this.Xa && (X(this.q, Y(this, "Will abort after " + this.Xa + "ms if incomplete")), this.ca = Ub.setTimeout(A(this.Ba, this), this.Xa)), X(this.q, Y(this, "Sending request")), this.La = k, this.g.send(a), this.La = q
  }catch(j) {
    X(this.q, Y(this, "Send error: " + j.message)), nd(this, j)
  }
};
u.Ba = function() {
  "undefined" != typeof ca && this.g && (this.p = "Timed out after " + this.Xa + "ms, aborting", this.ia = oc, X(this.q, Y(this, this.p)), this.dispatchEvent("timeout"), this.abort(oc))
};
function nd(a, b) {
  a.R = q;
...
u.Mb = function() {
  !this.kb && !this.La && !this.aa ? this.rc() : qd(this)
};
u.rc = function() {
  qd(this)
};
...
function Y(a, b) {
  return b + " [" + a.Hb + " " + a.Na + " " + lc(a) + "]"
}
;function rd() {
  this.Tb = B()
}
new rd;
rd.prototype.set = t("Tb");
rd.prototype.reset = function() {
  this.set(B())
};
rd.prototype.get = aa("Tb");
  ...
  if(this.w.I) {
    if(0 == this.c) {
      if(this.a.debug("TestConnection: request complete for initial check"), this.ab) {
        this.c = 1;
        var a = Hd(this.b, this.ab, "/mail/images/cleardot.gif");
        L(a);
      ...
      2 == this.c && (this.a.debug("TestConnection: request complete for stage 2"), a = q, (a = fc() ? this.Sa : 200 > this.lb - this.Ia ? q : k) ? (this.a.debug("Test connection succeeded; using streaming connection"), V(Ed), Fd(this.b, this, k)) : (this.a.debug("Test connection failed; not using streaming"), V(Id), Fd(this.b, this, q)))
    }
  }else {
...
u.eb = function(a, b, c, d, f) {
  ...
  Sd(this) && (this.T = new ud(this, this.a), this.T.W(this.u), this.T.Xb(this.O), this.T.eb(a))
};
...
u.Xb = t("O");
function Xd(a) {
  !a.o && !a.D && (a.D = W(A(a.Pb, a), 0), a.U = 0)
}
u.Pb = function(a) {
  this.D = l;
...
function Yd(a) {
  ...
  6 < a.ea && 0 < b ? (d = a.s[0].Jb, c.push("ofs=" + d)) : d = 0;
  for(var f = 0;f < b;f++) {
    var g = a.s[f].Jb, j = a.s[f].map, g = 6 >= a.ea ? f : g - d;
    try {
      bb(j, function(a, b) {
...
function $d(a) {
  !a.k && !a.K && (a.sb = 1, a.K = W(A(a.Ob, a), 0), a.da = 0)
}
function ae(a) {
  if(a.k || a.K) {
...
u.Ob = function() {
  ...
  if(Sd(this)) {
    ...
    this.k = new T(this, this.a, this.X, "rpc", this.sb);
    this.k.W(this.u);
    this.k.Yb(this.la);
    var a = this.tb.n();
    K(a, "RID", "rpc");
    ...
    if(this.h = a.h, this.o == a && 3 == this.c) {
      if(7 < this.ea) {
        ...
        if(w(c) && 3 == c.length) {
          ...
          if(0 == f[0]) {
            ...
            this.Ib = f[1], c = this.Ib - this.va, 0 < c && (f = f[2], this.a.debug(f + " bytes (in " + c + " arrays) are outstanding on the BackChannel"), 37500 > f && (this.qb && 0 == this.da) && !this.$ && (this.$ = W(A(this.qc, this), 6E3)))
          }
        }else {
      ...
      if(this.k == a && Wd(this), !/^[\s\xa0]*$/.test(b)) {
        ...
        for(var f = this.e && this.e.channelHandleMultipleArrays ? [] : l, g = 0;g < c.length;g++) {
          ...
          this.va = j[0];
          j = j[1];
          2 == this.c ? "c" == j[0] ? (this.X = j[1], this.M = this.correctHostPrefix(j[2]), j = j[3], this.ea = j != l ? j : 6, this.c = 3, this.e && this.e.channelOpened(this), this.tb = zd(this, this.M, this.G), $d(this)) : "stop" == j[0] && Z(this, 7) : 3 == this.c && ("stop" == j[0] ? (f && f.length && (this.e.channelHandleMultipleArrays(this, f), f.length = 0), Z(this, 7)) : "noop" != j[0] && (f ? f.push(j) : this.e && this.e.channelHandleArray(this, j)), this.da = 0)
        }
...
u.correctHostPrefix = function(a) {
  return this.dc ? this.e ? this.e.correctHostPrefix(a) : a : l
};
u.qc = function() {
  ...
  if(0 != this.c) {
    if(a.I) {
      ...
      if(3 == c || 7 == c || 0 == c && 0 < this.h) {
        ...
        var d;
        if(d = 1 == b) {
          this.o || this.D ? (this.a.H("Request already in progress"), d = q) : this.c == Md || this.U >= (this.Ha ? 0 : this.ib) ? d = q : (this.a.debug("Going to retry POST"), this.D = W(A(this.Pb, this, a), be(this, this.U)), this.U++, d = k)
        }
        if(d || 2 == b && ae(this)) {
          return
        }
...
$ = function(a, b) {
  ...
  g = function() {
    ...
    if(b.failFast) {
      ...
      if((g.o || g.D) && g.U > (g.Ha ? 0 : g.ib)) {
        g.a.info("Retry count " + g.U + " > new maxRetries " + (g.Ha ? 0 : g.ib) + ". Fail immediately!"), g.o ? (g.o.cancel(), g.ja(g.o)) : (v.clearTimeout(g.D), g.D = l, Z(g, 2))
      }
    }
    return p.eb("" + a + "/test", "" + a + "/bind", l, f != l ? f.X : h, f != l ? f.va : h)
  };
  this.open = function() {
  ...
  this.close = function() {
    ...
    d = 0;
    if(m.readyState !== $.CLOSED) {
      return s($.$a), p.disconnect()
    }
  };
  this.sendMap = function(a) {
    var b;
    ((b = m.readyState) === $.$a || b === $.CLOSED) && e(Error("Cannot send to a closed connection"));
    b = p;
